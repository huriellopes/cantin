...
return [
    // Perguntas frequentes exibidas na home. A resposta aceita HTML simples.
    'items' => [
        [
        ...
        [
            ...
            'answer' => 'A página do CANTIn oferece uma ferramenta de busca que permite localizar terreiros cadastrados por região ou estado. <a href="/terreiros" wire:navigate title="lista de terreiros">Lista de Terreiros</a>.',
        ],
        [
