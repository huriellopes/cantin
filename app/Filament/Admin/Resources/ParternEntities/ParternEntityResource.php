...
namespace App\Filament\Admin\Resources\ParternEntities;

use Exception;
use Filament\Tables\Columns\TextColumn;
use App\Filament\Admin\Resources\ParternEntities\Pages\ListParternEntities;
use App\Filament\Admin\Resources\ParternEntities\Pages\CreateParternEntity;
use App\Filament\Admin\Resources\ParternEntities\Pages\EditParternEntity;
...
class ParternEntityResource extends Resource
{
    ...
    {
        return [
            'index' => ListParternEntities::route('/'),
            'create' => CreateParternEntity::route('/create'),
            'edit' => EditParternEntity::route('/{record}/edit'),
        ];
    }
}
