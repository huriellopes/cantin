                            ...
                            Fieldset::make()
                                ...
                                ->schema([
                                    Forms\Components\TextInput::make('name')
                                        ...
                                        ->label('Nome'),
                                    Forms\Components\Select::make('nation_terreiro_id')
                                    ...
                                    Forms\Components\TextInput::make('phone')
                                        ...
                                        ->label('Telefone'),
                                    Forms\Components\TextInput::make('leadership_orunko')
                                        ->required()
                                        ->maxLength(255)
                                    ...
                                    Forms\Components\Select::make('color_of_leadership')
...
//                                            }
                                    ...
                                    Forms\Components\Hidden::make('address.latitude')
                                        ->label('Latitude'),
                                    Forms\Components\Hidden::make('address.longitude')
                                        ->label('Longitude'),
                                ]),
                        ]),
                    Wizard\Step::make('Perguntas')
                        ->columnSpanFull()
                        ->schema([
                            Fieldset::make()
                                ->schema([
                                    Forms\Components\Select::make('question.type_people_id')
                                    ...
                                    Forms\Components\TextInput::make('question.number_of_children_of_saint')
                                        ->required()
                                        ->numeric()
                                        ->validationMessages([
                                            'required' => 'O campo :attribute obrigatório.',
                                    ...
                                    Forms\Components\TextInput::make('question.number_of_children_of_saint_trans')
                                        ->required()
                                        ->numeric()
                                        ->validationMessages([
                                            'required' => 'O campo :attribute é obrigatório.',
                                    ...
                                    Forms\Components\Select::make('question.trans_men_and_women')
                                    ...
                                    Forms\Components\Select::make('question.name_gender')
                                    ...
                                    Forms\Components\Select::make('question.fully_welcomes')
                                    ...
                                    Forms\Components\Select::make('question.respect_for_trans_people')
                                    ...
                                    Forms\Components\Select::make('question.suffered_aggregation')
                                    ...
                                    Forms\Components\Select::make('question.inclusion_of_the_name_of_the_land')
                                    ...
                                    Forms\Components\Select::make('question.suggestion_id')
                                    ...
                                    Forms\Components\Textarea::make('question.suggestion_text')
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('phone')
                    ->searchable()
                    ->label('Telefone'),
                Tables\Columns\TextColumn::make('leadership_orunko')
                    ->searchable()
                    ->wrap()
