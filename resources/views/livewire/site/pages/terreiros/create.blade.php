                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <select id="nation_terreiro_id" wire:model.live="form.nation_terreiro_id" class="{{ $field }}">
                                <option value="">{{ __('Select the nation') }}</option>
                                @foreach ($nations as $nation)<option value="{{ $nation->id }}">{{ $nation->name }}</option>@endforeach
                            </select>
                            @error('form.nation_terreiro_id') <p class="{{ $err }}">{{ $message }}</p> @enderror
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="leadership_orunko" wire:model.live="form.leadership_orunko" class="{{ $field }}" />
                            @error('form.leadership_orunko') <p class="{{ $err }}">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label for="color_of_leadership" class="{{ $label }}">{{ __('page_terreiros_create.label_color_of_leadership') }}</label>
                            <select id="color_of_leadership" wire:model.live="form.color_of_leadership" class="{{ $field }}">
                            ...
                            @error('form.color_of_leadership') <p class="{{ $err }}">{{ $message }}</p> @enderror
                        </div>
                    </div>
                </div>
            </fieldset>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" id="zipcode" maxlength="9" x-mask="99999-999" wire:model.live="form.zipcode" class="{{ $field }}" />
            ...
            <fieldset class="rounded-2xl border border-slate-200 p-5">
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <select id="type_people_id" wire:model.live="form.type_people_id" class="{{ $field }}">
                        ...
                        @error('form.type_people_id') <p class="{{ $err }}">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label for="number_of_children_of_saint" class="{{ $label }}">{{ __('page_terreiros_create.label_number_of_children_of_saint') }}</label>
                        <input type="number" id="number_of_children_of_saint" wire:model.live="form.number_of_children_of_saint" class="{{ $field }}" />
                        @error('form.number_of_children_of_saint') <p class="{{ $err }}">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        ...
                        <input type="number" id="number_of_children_of_saint_trans" wire:model.live="form.number_of_children_of_saint_trans" class="{{ $field }}" />
                        @error('form.number_of_children_of_saint_trans') <p class="{{ $err }}">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label for="trans_men_and_women" class="{{ $label }}">{{ __('page_terreiros_create.label_trans_men_and_women') }}</label>
                        <select id="trans_men_and_women" wire:model.live="form.trans_men_and_women" class="{{ $field }}">
                    ...
                    <div>
                        ...
                        @error('form.fully_welcomes') <p class="{{ $err }}">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label for="respect_for_trans_people" class="{{ $label }}">{{ __('page_terreiros_create.label_respect_for_trans_people') }}</label>
                        <select id="respect_for_trans_people" wire:model.live="form.respect_for_trans_people" class="{{ $field }}">
                            <option value="">{{ __('page_terreiros_create.select_option') }}</option>
                        ...
                        @error('form.respect_for_trans_people') <p class="{{ $err }}">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label for="suffered_aggregation" class="{{ $label }}">{{ __('page_terreiros_create.label_suffered_aggregation') }}</label>
                        <select id="suffered_aggregation" wire:model.live="form.suffered_aggregation" class="{{ $field }}">
                            <option value="">{{ __('page_terreiros_create.select_option') }}</option>
                            <option value="sim">{{ __('page_terreiros_create.option_yes') }}</option>
                            <option value="não">{{ __('page_terreiros_create.option_no') }}</option>
                        </select>
                        @error('form.suffered_aggregation') <p class="{{ $err }}">{{ $message }}</p> @enderror
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        <select id="inclusion_of_the_name_of_the_land" wire:model.live="form.inclusion_of_the_name_of_the_land" class="{{ $field }}">
                            <option value="">{{ __('page_terreiros_create.select_option') }}</option>
                        ...
                        @error('form.inclusion_of_the_name_of_the_land') <p class="{{ $err }}">{{ $message }}</p> @enderror
                    </div>
                    <div class="sm:col-span-2">
                        <label for="suggestion_id" class="{{ $label }}">{{ __('page_terreiros_create.label_suggestion') }}</label>
                        <select id="suggestion_id" wire:model.live="form.suggestion_id" class="{{ $field }}">
                        ...
                        @error('form.suggestion_id') <p class="{{ $err }}">{{ $message }}</p> @enderror
                    </div>
                    @if ($showField)
                        <div class="sm:col-span-2">
                            <label for="suggestion_text" class="{{ $label }}">{{ __('page_terreiros_create.label_suggestion_text') }}</label>
                            <textarea id="suggestion_text" wire:model.live="form.suggestion_text" rows="3" class="{{ $field }}"></textarea>
                            @error('form.suggestion_text') <p class="{{ $err }}">{{ $message }}</p> @enderror
                        </div>
                    @endif
                </div>
            </fieldset>
