<div>
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button wire:click="toggleCommentForm" class="btn btn-sm btn-outline-primary" wire:loading.attr="disabled">
                ...
                <div class="row g-3">
                    @guest
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="name" id="name" wire:model.live="name" required>
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label">{{ __('Email') }}</label>
                            <input type="email" class="form-control" name="email" id="email" wire:model.live="email" required>
                        </div>
                    @else
                        <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" name="newComment" id="newComment" rows="4" wire:model.live="newComment" required></textarea>
                    </div>
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                            <i class="bi bi-send-fill me-1"></i>Enviar comentário
                        </button>
                        <button type="button" wire:click="toggleCommentForm" class="btn btn-outline-secondary ms-2">
                            Cancelar
                        </button>
                    </div>
                </div>
