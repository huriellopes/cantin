<div class="space-y-6">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-slate-100 p-4">
            <input wire:model.live.debounce.400ms="search" type="search" placeholder="{{ __('crud_trans_peoples.search_placeholder') }}"
            ...
            <table class="min-w-full divide-y divide-slate-100 text-sm">
                <thead class="bg-slate-50 text-left text-xs font-semibold uppercase tracking-wide text-slate-500">
                    <tr>
                        ...
                        <th class="px-4 py-3">{{ __('crud_trans_peoples.column_name') }}</th>
                        <th class="px-4 py-3">{{ __('crud_trans_peoples.column_email') }}</th>
